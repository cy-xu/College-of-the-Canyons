 ...
 * Description: Node.java represents each position that DataItems can be stored in.  
 */
import java.io.*;
...
// -------------------------------------------------------------
   ...
   public static void setOrder(int o) {//changes the order of the ORDER variable
      ORDER = o;
   }
