 ...
 * Description: This class describe a node with which to insert DataItems into.
                The amount of data items that can be inserted into a node is depended upon the ORDER variable.
 */
public class Node {
