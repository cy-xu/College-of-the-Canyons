...
Description: This class contains the characteristics of a node. Creates an object
    that has links to its children, parent, keys, and order.
 */
...
// -------------------------------------------------------------
    public static void setOrder(long newOrder)
    {
        ORDER = (int) newOrder;
    }
