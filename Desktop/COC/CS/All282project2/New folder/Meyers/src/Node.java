...
//11/15/15
//class 282 project 2
//Node class. Includes methods for working with the tree's nodes including connecting/disconnecting children, inserting items, getting and setting tree order, display and the get methods. 
...
// -------------------------------------------------------------
   public static void setOrder()  {
       ...
       order = UserInput.getInt(); 
       while(order < 4){
           System.out.println("Order cannot be less than 4");
           order = UserInput.getInt();
       }
   }
//--------------------------------------------------------------   
