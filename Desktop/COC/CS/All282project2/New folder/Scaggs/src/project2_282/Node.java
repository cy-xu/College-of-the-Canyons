...
class Node {
    ...
    // -------------------------------------------------------------
    public static void setOrder(int o) {            //Changes the order of the tree
        ORDER = o;                                  //by changing th ORDER varible
    }
    // -------------------------------------------------------------
    public static int getOrder() {                  //Returns the order of the tree
        return ORDER;
    }
    // -------------------------------------------------------------
