...
// -------------------------------------------------------------
    ...
    public void insert(DataItem tempItem) {
        ...
        while (true) {
            if (curNode.isFull()) { // if node full,
                ...
                curNode = getNextChild(curNode, tempItem.dData); // search once
            } // end if(node is full)
    ...
    // insert a value that is converted to a dataitem in the tree
...
// -------------------------------------------------------------
    public void split(Node thisNode) { // split the node
        DataItem itemB, itemC;  // assumes node is full
