 ...
 *Description: Tree234App class for handling 234 tree data structure
 */
...
public class Tree234 {
    ...
    public void insertRecord(String record){ //set record from text file
