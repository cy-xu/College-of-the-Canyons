...
Description: This is the updated Figure 2.10 from the book that will now output the first four 
	powers of the bases 2,3,8,10, and 16.  These powers are not hardcoded, but rather, calculated with
	the pow(base,exponent) from the math.h file.
*/
