...
def distance(city1, city2):
    ...
    5.0
    """
    lat_dist = get_lat(city1) - get_lat(city2)
    lon_dist = get_lon(city1) - get_lon(city2)
...
def closer_city(lat, lon, city1, city2):
    ...
    'Bucharest'
    """
    base_city = make_city('base city',lat,lon)
    if distance(base_city,city1) < distance(base_city,city2):
...
def make_move(board, max_rows, max_cols, col, player):
    ...
    -1
    """
    if col >= 0 and (player == 'X' or player == 'O'):
